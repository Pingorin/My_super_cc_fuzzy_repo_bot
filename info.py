...
# --- DATABASE SETTINGS ---
DATABASE_URI = os.environ.get("DATABASE_URI", "mongodb+srv://Mikuu7:Mikuu7@cluster0.rtgbvhi.mongodb.net/?retryWrites=true&w=majority&minPoolSize=1&maxPoolSize=20")
