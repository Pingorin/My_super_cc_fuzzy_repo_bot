...
# --- DATABASE SETTINGS ---
DATABASE_URI = os.environ.get("DATABASE_URI", "mongodb+srv://Candy4:Candy4@cluster0.qrqzqvo.mongodb.net/?retryWrites=true&w=majority&minPoolSize=1&maxPoolSize=20")
